...
<script type="text/javascript">
	...
	function coupon_purchase_order(){
		...
		location.href="../academy/coupon_purchase_order?client_no="+client_no+"&member_no="+member_no+"&menu_no="+menu_no+"&member_name="+member_name+"&client_name="+client_name+"&coupon_history_quantity="+coupon_history_quantity+"&coupon_history_cost="+coupon_history_cost;
	}
</script>
</head>
<body>
