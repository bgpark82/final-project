...
INSERT INTO member VALUES(1,'김회계','test1','test1',NULL,'1',SYSDATE,NULL,NULL,NULL,'1@1','ROLE_ACCOUNT',NULL,NULL,'1' );
INSERT INTO member VALUES(2,'이홍보','test2','test2',NULL,'2',SYSDATE,NULL,NULL,NULL,'2@2','ROLE_PROMOTION',NULL,NULL,'1' );
INSERT INTO member VALUES(3,'박운영','test3','test3',NULL,'3',SYSDATE,NULL,NULL,NULL,'3@3','ROLE_OPERATION',NULL,NULL,'1' );
COMMIT;
SELECT * FROM member;
